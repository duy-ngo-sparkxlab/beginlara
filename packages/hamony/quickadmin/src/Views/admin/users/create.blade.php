...
@section('content')
    ...
    <div class="form-group">
        {!! Form::label('confirm_password', trans('quickadmin::admin.users-create-confirm_password'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::password('password_confirmation', ['class'=>'form-control', 'placeholder'=> trans('quickadmin::admin.users-create-confirm_password_placeholder')]) !!}
        </div>
    </div>
